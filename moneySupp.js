...
d3.csv("assets/data/Data_Combined_d3.csv").then(function(financeData) {
   ...
   financeData.forEach(function(data) {
     ...
     data.MONEY_SUPP = +data.MONEY_SUPP;
     console.log(data.Date);
   });
   ...
   var yLinearScale = d3.scaleLinear()
     .domain([0, d3.max(financeData, d => d.MONEY_SUPP)])
     .range([height, 0]);
